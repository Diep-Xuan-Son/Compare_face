import os, sys
import numpy as np
import tritonclient.grpc.aio as grpcclient_aio #using for async tritonclient
import tritonclient.grpc as grpcclient

def get_triton_client_aio(ip_address="127.0.0.1:8001"):
	try:
		triton_client = grpcclient_aio.InferenceServerClient(
			url=ip_address
		)
